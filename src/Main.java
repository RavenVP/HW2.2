...
//        vladimir.say();
        ...
        Car car1 = new Car(null,"Grande",1.7,"Жёлтый", -2015,"Россия", "Седан","A123AA321",1,1, "Автомат",150);
        Car car2 = new Car("Audi","A8 50 L TDI quattro",3.0 ,"Чёрный", 0,"Германия", "Седан","N705NN432",4,2,"Автомат",150);
        Car car3 = new Car("BMW","Z8",3.0,"Чёрный", 2021,"Германия", "","",2,3,"",150);
        Car car4 = new Car("Kia","Sportage 4 поколение",2.4,"Красный", 2018,"Южная Корея", "","A123AA",4,3,"Автомат",150);
        Car car5 = new Car("Hyundai","Avante",1.6,"Оранжевый", 2016,"Южная Корея", "Седан","A123AA",5,0,"Механика",150);
        ...
        Train train1 = new Train("Ласточка", "В-901", "", 2011, "Россия", 301, 3500, "Белорусский вокзал", "Минск-Пассажирский", 11);
        Train train2 = new Train("Ленинград", "D-125", "", 2019, "Россия", 270, 1700, "Ленинградский вокзал", "Ленинград-Пассажирский", 8);

        train1.info();
        train2.info();

        Bus bus1 = new Bus("MAN","Lions City","Черный",2020,"Германия",150);
        Bus bus2 = new Bus("Hyundai","H350","Серый",2019,"Южная Корея",160);
        Bus bus3 = new Bus("Ford","Sprinter 2","Красмный",2021,"США",140);
